    ...
    <div class="content-wrapper">
        <section class="wrapper bg-gray">
            ...
            <figure class="position-absoute" style="bottom: 0; left: 0; z-index: 2;"><img
                    src="{{ asset('template/assets/img/photos/bg12.jpg') }}" alt=""></figure>
        </section>
        <!-- /section -->
        <section class="wrapper bg-light angled upper-end lower-end">
            <div class="container py-14 py-md-16">
                <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
                        ...
                        <div class="overlap-grid overlap-grid-2">
                            <div class="item">
                                <figure class="rounded shadow"><img
                                        src="{{ asset('template/assets/img/photos/about2.jpg') }}"
                                        srcset="{{ asset('template/assets/img/photos/about2@2x.jpg 2x') }}" alt="">
                                </figure>
                            </div>
                            <div class="item">
                                <figure class="rounded shadow"><img
                                        src="{{ asset('template/assets/img/photos/about3.jpg') }}"
                                        srcset="{{ asset('template/assets/img/photos/about3@2x.jpg 2x') }}" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-lg-6">
                        <img src="{{ asset('template/assets/img/icons/lineal/megaphone.svg') }}"
                            class="icon-svg icon-svg-md mb-4" alt="">
                ...
                <div class="row mb-5">
                    <div class="col-md-10 col-xl-8 col-xxl-7 mx-auto text-center">
                        <img src="{{ asset('template/assets/img/icons/lineal/list.svg') }}"
                            class="icon-svg icon-svg-md mb-4" alt="">
                ...
                <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-6">Nullam id dolor id nibh ultricies vehicula ut id elit. Vestibulum id
                            ligula porta felis euismod semper. Aenean lacinia bibendum nulla sed consectetur. Sed posuere
                ...
                <div class="row gx-lg-8 gx-xl-0 align-items-center">
                    <div class="col-md-5 col-lg-5 col-xl-4 offset-xl-1 d-none d-md-flex position-relative align-self-end">
                        <div class="shape rounded-circle bg-pale-primary rellax w-21 h-21 d-md-none d-lg-block"
                            data-rellax-speed="1" style="top: 7rem; left: 1rem; transform: translate3d(0px, 183px, 0px);">
                        </div>
                        <figure><img src="{{ asset('template/assets/img/photos/co1.png') }}"
                                srcset="{{ asset('template/assets/img/photos/co1@2x.png 2x') }}" alt="">
                        </figure>
                    </div>
                    <!--/column -->
                    <div class="col-md-7 col-lg-6 col-xl-6 col-xxl-5 offset-xl-1">
                        <div class="swiper-container dots-start dots-closer mt-md-10 mb-md-15 swiper-container-0"
                            data-margin="30" data-dots="true">
                            <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                <div class="swiper-wrapper" id="swiper-wrapper-bafdab10155cf1c42" aria-live="off"
                                    ...
                                    <!--/.swiper-slide -->
                                    <div class="swiper-slide" style="width: 555px; margin-right: 30px;" role="group"
                                        aria-label="3 / 3">
                                        <blockquote class="icon fs-lg">
                                            <p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                                                Vestibulum ligula porta felis euismod semper. Cras justo odio consectetur
            ...
            <div class="container py-14 py-md-16">
                <div class="row mb-3">
                    <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
                        <img src="{{ asset('template/assets/img/icons/lineal/team.svg') }}"
                            class="icon-svg icon-svg-md mb-4" alt="">
                ...
                <div class="position-relative">
                    <div class="shape rounded-circle bg-soft-yellow rellax w-16 h-16" data-rellax-speed="1"
                        style="bottom: 0.5rem; right: -1.7rem; transform: translate3d(0px, 286px, 0px);"></div>
                    <div class="shape rounded-circle bg-line red rellax w-16 h-16" data-rellax-speed="1"
                        style="top: 0.5rem; left: -1.7rem; transform: translate3d(0px, 262px, 0px);"></div>
                    <div class="swiper-container dots-closer mb-6 swiper-container-1" data-margin="0" data-dots="true"
                        data-items-xxl="4" data-items-xl="3" data-items-lg="3" data-items-md="2" data-items-xs="1">
                        <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-2cfb1a99568cd4f6" aria-live="off"
                                style="cursor: grab; transform: translate3d(0px, 0px, 0px);">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te1.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te1@2x.jpg 2x') }}"
                                                    alt="">
                                                <h4 class="mb-1">Coriss Ambady</h4>
                                                <div class="meta mb-2">Financial Analyst</div>
                                                <p class="mb-2">Fermentum massa justo sit amet risus morbi leo.
                                                </p>
                                ...
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 6"
                                    ...
                                    <div class="item-inner">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te2.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te2@2x.jpg 2x') }}"
                                                    alt="">
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" style="width: 370px;" role="group" aria-label="3 / 6">
                                    <div class="item-inner">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te3.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te3@2x.jpg 2x') }}"
                                                    alt="">
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="4 / 6" style="width: 370px;">
                                    <div class="item-inner">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te4.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te4@2x.jpg 2x') }}"
                                                    alt="">
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="5 / 6" style="width: 370px;">
                                    <div class="item-inner">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te5.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te5@2x.jpg 2x') }}"
                                                    alt="">
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 370px;">
                                    <div class="item-inner">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="rounded-circle w-15 mb-4"
                                                    src="{{ asset('template/assets/img/avatars/te6.jpg') }}"
                                                    srcset="{{ asset('template/assets/img/avatars/te6@2x.jpg 2x') }}"
                                                    alt="">
                ...
                <div class="row mb-10">
                    <div class="col-xl-10 mx-auto">
                        <div class="row align-items-center counter-wrapper gy-6 text-center">
                            <div class="col-md-3">
                                <img src="{{ asset('template/assets/img/icons/lineal/check.svg') }}"
                                    class="icon-svg icon-svg-lg text-primary mb-3" alt="">
                                <h3 class="counter" style="visibility: visible;">7518</h3>
                                <p>Completed Projects</p>
                            </div>
                            <!--/column -->
                            <div class="col-md-3">
                                <img src="{{ asset('template/assets/img/icons/lineal/user.svg') }}"
                                    class="icon-svg icon-svg-lg text-primary mb-3" alt="">
                            ...
                            <!--/column -->
                            <div class="col-md-3">
                                <img src="{{ asset('template/assets/img/icons/lineal/briefcase-2.svg') }}"
                                    class="icon-svg icon-svg-lg text-primary mb-3" alt="">
                            ...
                            <!--/column -->
                            <div class="col-md-3">
                                <img src="{{ asset('template/assets/img/icons/lineal/award-2.svg') }}"
                                    class="icon-svg icon-svg-lg text-primary mb-3" alt="">
                                <h3 class="counter" style="visibility: visible;">4523</h3>
                                <p>Awards Won</p>
                            </div>
                            <!--/column -->
                        </div>
                ...
                <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
                    <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
                        <div class="shape bg-dot primary rellax w-17 h-21" data-rellax-speed="1"
                            style="top: -2rem; left: -1.4rem; transform: translate3d(0px, 331px, 0px);"></div>
                        <figure class="rounded"><img src="{{ asset('template/assets/img/photos/about4.jpg') }}"
                                srcset="{{ asset('template/assets/img/photos/about4@2x.jpg 2x') }}" alt=""></figure>
                    </div>
                    <!--/column -->
                    <div class="col-lg-6">
                        <img src="{{ asset('template/assets/img/icons/lineal/telemarketer.svg') }}"
                            class="icon-svg icon-svg-md mb-4" alt="">

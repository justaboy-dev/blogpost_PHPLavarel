@extends('admin_dashboard.layout.main') @section('tittle', 'Create Category')
@section('content')
    ...
    <form onsubmit="return false;" method="post">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group mb-4">
                    <h4>Category slug</h4>
                    <input type="text" id="slug" name="slug" class="form-control" placeholder="Category slug" required />
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group mb-4">
                    ...
                    <div id="upload" class="custom_image_box" role="button">
                        ...
                        <input type="text" id="postthumbnail" name="category_thumb" hidden required>
                    </div>
                </div>
                <div class="form-group mb-4 mt-8">
                    <input type="submit" id="categorySave" class="btn btn-success btn-lg btn-block" value="Save">
                </div>
            </div>
        </div>
    </form>
...
@section('custom-js')
    ...
    <script>
        ...
        $(document).on('click', '#categorySave', (e) => {
            e.preventDefault;
            let $this = e.target;

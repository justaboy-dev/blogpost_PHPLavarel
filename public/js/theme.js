...
var theme = {
     ...
     * Do not forget to remove dependency from src/js/ and recompile.
     */
    init: function () {
        theme.stickyHeader();
        theme.subMenu();
     ...
     * Requires assets/js/headhesive.min.js
     */
    stickyHeader: () => {
     ...
     * Requires assets/js/isotope.pkgd.min.js
     * Requires assets/js/imagesloaded.pkgd.min.js
     */
    isotope: function () {
     ...
     * Requires assets/js/smoothscroll.js
     */
     ...
     * Requires assets/js/svg-inject.min.js
     */
    svgInject: function () {
     ...
     * Requires assets/js/rellax.min.js
     */
    rellax: function () {
     ...
     * Requires assets/js/scrollCue.min.js
     */
    scrollCue: function () {
     ...
     * Requires assets/js/swiper-bundle.min.js
     */
     ...
     * Requires assets/js/glightbox.js
     */
    lightbox: function () {
     ...
     * Requires assets/js/plyr.js
     */
    plyr: function () {
        var players = Plyr.setup(".player", { loadSprite: true });
    },
    /**
     * Progressbar
     * Enables animated progressbars
     * Requires assets/js/progressbar.min.js
     * Requires assets/js/noframework.waypoints.min.js
     */
     ...
     * Requires assets/js/counterup.min.js
     * Requires assets/js/noframework.waypoints.min.js
     */
    counterUp: function () {
     ...
     * Requires assets/js/itooltip.min.js
     */
    iTooltip: function () {
    ...
    //                                         fetch(
    //                                             "template/assets/php/contact.php",
    //                                             {
    //                                                 method: "post",
    //                                                 body: data,
    //                                             }
     ...
     * Requires assets/js/replaceme.min.js
     */
     ...
     * Requires assets/js/clipboard.min.js
     */
